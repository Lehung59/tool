...
class FreeDogsAPIClient {
    constructor() {
        this.headers = {
            ...
            "Sec-Ch-Ua": '"Not/A)Brand";v="99", "Samsung Browser";v="15", "Chromium";v="115"',
            "Sec-Ch-Ua-Mobile": "?1",
            "Sec-Ch-Ua-Platform": '"Android"',
            "Sec-Fetch-Dest": "empty",
            "Sec-Fetch-Mode": "cors",
            "Sec-Fetch-Site": "same-site",
            "User-Agent": "Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-S901B) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/15.0 Chrome/115.0.0.0 Mobile Safari/537.36"
        };
    }
    ...
    async main() {
        ...
        while (true) {
            ...
            const randomTime = Math.floor(Math.random() * (150 - 60 + 1)) + 60;
