...
class TonStation {
    ...
    log(msg, type = 'info') {
        ...
        switch (type) {
            case 'success':
                console.log(`[${timestamp}] [TonStation][*] ${msg}`.green);
                break;
            case 'custom':
                console.log(`[${timestamp}] [TonStation][*] ${msg}`.magenta);
                break;
            case 'error':
                console.log(`[${timestamp}] [TonStation][!] ${msg}`.red);
                break;
            case 'warning':
                console.log(`[${timestamp}] [TonStation][*] ${msg}`.yellow);
                break;
            default:
                console.log(`[${timestamp}] [TonStation][*] ${msg}`.blue);
        }
    }
    ...
    async main() {
        ...
        while (true) {
            ...
            const randomTime = Math.floor(Math.random() * (900 - 600 + 1)) + 600;
