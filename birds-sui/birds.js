...
class BirdX {
    constructor() {
        this.headers = {
            ...
            "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 15_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.0 Mobile/15E148 Safari/604.1 (iPhone 15 Pro Max)"
        };
    }
    ...
    async main() {
        ...
        while (true) {
            ...
            const minTime = 5 * 60; // 15 phút
            const maxTime = 15 * 60; // 60 phút
