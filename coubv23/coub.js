...
class Coub {
    constructor() {
        this.headers = {
            ...
            "User-Agent": "Mozilla/5.0 (Linux; Android 12; Samsung Galaxy S9) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Mobile Safari/537.36",
    ...
    log(msg, type = 'info') {
        ...
        switch (type) {
            case 'success':
                console.log(`[Coub][${timestamp}] [*] ${msg}`.green);
                break;
            case 'custom':
                console.log(`[Coub][${timestamp}] [*] ${msg}`.magenta);
                break;
            case 'error':
                console.log(`[Coub][${timestamp}] [!] ${msg}`.red);
                break;
            case 'warning':
                console.log(`[Coub][${timestamp}] [*] ${msg}`.yellow);
                break;
            default:
                console.log(`[Coub][${timestamp}] [*] ${msg}`);
        }
    }
